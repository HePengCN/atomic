...
int ptimer_set(htimer_t htimer, uint32_t start_offset_ms, uint32_t interval_ms)
{
    ...
    {
        .it_value = {.tv_sec = start_offset_ms / 1000, .tv_nsec = 1000000l * (start_offset_ms % 1000)},
        .it_interval = {.tv_sec = interval_ms / 1000, .tv_nsec = 1000000l * (interval_ms % 1000)}
    };
