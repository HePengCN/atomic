...
#include "log.h"
#define COM_LOG_DEBUG(fmt, args...) LOG_DEBUG("[TIMER]%s Line %d: "fmt, basename(__FILE__), __LINE__, ##args)
#define COM_LOG_INFO(fmt, args...) LOG_INFO("[TIMER]%s Line %d: "fmt, basename(__FILE__), __LINE__, ##args)
#define COM_LOG_WARN(fmt, args...) LOG_WARN("[TIMER]%s Line %d: "fmt, basename(__FILE__), __LINE__, ##args)
#define COM_LOG_ERROR(fmt, args...) LOG_ERROR("[TIMER]%s Line %d: "fmt, basename(__FILE__), __LINE__, ##args)
#else
#include <stdio.h>
